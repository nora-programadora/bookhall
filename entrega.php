<?php
     ...
     $InsercionDevolucion = "INSERT INTO devolucion (id_ejemplar , fecha_prestamo ,fecha_limite, id_prestamo , id_usuario, tarde) 
                            VALUES ('$idEjemplarFinal', '$fecha_prestamo' , '$fecha_final' , '$idprestamo', '$idUsuarioFinal', b'$tarde' ) ";
