...
<div><h1 class="titulo">Actualizar ejemplar de libro</h1></div>
<div class="formulario">
    <form action="actualizar-ejemplar-libro.php" method="post" enctype="multipart/form-data" class="registro-usuario titulo" >
    	<center>
        <table class="formulario">
	     ...
	     <div><h1 class="titulo">Información del ejemplar</h1></div>
            ...
            <br>
             ...
             <div><h1 class="titulo">Actualizar información del ejemplar?</h1></div>
             <div class="botones r-usuario">
                 <label><input type="reset" value="Borrar"></input></label>
                 <label><input type="submit" value="Actualizar" class="enviar"></input></label>
             </div>
    </form>
</div>
</body>
